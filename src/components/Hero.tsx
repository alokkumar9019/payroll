...
export default function Hero() {
 return (
  <section
   id="home"
   className="relative inset-0 bg-black/100 z-0"
   aria-label="Hero"
  >
   <div className="relative container mx-auto px-4 py-10 min-h-[calc(100vh-64px)] grid items-center">
    ...
    >
     ...
     {/* LEFT: Content with added padding-left to move right */}
     <div className="pl-8 md:pl-16">
      ...
      <motion.p
       variants={rise}
       className="mt-4 max-w-2xl text-base font-bold text-white dark:text-white"
      >
     ...
     >
      <Lottie
       ...
       loop
       className="w-full max-w-xl h-[500px] md:h-[620px]"
      />
     </motion.div>
